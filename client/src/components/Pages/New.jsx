...
const New = ({match, getNewProducts, sortNameAsc, sortNameDesc, sortPriceAsc, sortPriceDesc, sortBySearch, sortClear}) => {
...
const mapDispatchToProps = (dispatch) => {
    return{
        getNewProducts: path => dispatch(getProducts(path)),
