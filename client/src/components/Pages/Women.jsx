...
const Women = ({match, getWomenProducts, sortNameAsc, sortNameDesc, sortPriceAsc, sortPriceDesc, sortBySearch, sortClear}) => {
    ...
    return (
        <>
            <div className="l-women container">
...
const mapDispatchToProps = (dispatch) => {
    return{
        getWomenProducts: path => dispatch(getProducts(path)),
