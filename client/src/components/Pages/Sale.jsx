...
const Sale = ({match, getSaleProducts, sortNameAsc, sortNameDesc, sortPriceAsc, sortPriceDesc, sortBySearch, sortClear}) => {
    ...
    return (
        <>
            <div className="l-sale container">
...
const mapDispatchToProps = (dispatch) => {
    return{
        getSaleProducts: path => dispatch(getProducts(path)),
